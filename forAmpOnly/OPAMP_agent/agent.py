...
from .subagents.CIRfileAgent import CIR_file_agent
from .subagents.CIRfileAddModelAgent import CIR_file_add_model_agent

# Create the sequential agent with minimal callback
root_agent = SequentialAgent(
    name="LeadQualificationPipeline",
    sub_agents=[opamp_info_agent, DC_simulate_agent, CIR_file_agent, CIR_file_add_model_agent],
