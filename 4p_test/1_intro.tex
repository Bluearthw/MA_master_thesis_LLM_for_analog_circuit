...
\IEEEPARstart{A}{nalog} and mixed-signal circuits form the essential interface between the digital world of computation and the continuous signals of the physical world, making them critical in a vast array of modern applications
. Despite their ubiquity, the design and sizing of these circuits remain a formidable challenge
